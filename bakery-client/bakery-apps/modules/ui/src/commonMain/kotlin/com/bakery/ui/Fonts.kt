...
object Fonts {
    ...
    val displayTextStyle: TextStyle
        ...
        get() = when (windowUtils.getScreenSize()) {
            ScreenSize.Compact -> MaterialTheme.typography.displaySmall
            ScreenSize.Medium -> MaterialTheme.typography.displayMedium
            ScreenSize.Large -> MaterialTheme.typography.displayLarge
        }
